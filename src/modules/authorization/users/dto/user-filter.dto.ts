import { IsString, IsEnum, IsOptional, IsUUID, IsInt, Min, IsBoolean } from 'class-validator';
...
export class UserFilterDto {
  ...
  @ApiProperty({ example: 'ACTIVE', enum: ['ACTIVE', 'INACTIVE', 'INVITED', 'LOCKED'], required: false })
  @IsString()
  @IsOptional()
  ...
  @ApiProperty({ example: 'FINANCE_APPROVER', required: false, description: 'Role code or Role ID' })
  @IsString()
  @IsOptional()
  role?: string;

  @ApiProperty({ example: false, required: false, description: 'Filter users who have zero active roles' })
  @IsBoolean()
  @IsOptional()
