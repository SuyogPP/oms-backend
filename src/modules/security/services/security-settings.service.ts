...
export class SecuritySettingsService {
  ...
  async getSettings(): Promise<SecuritySettingsResponseDto> {
    ...
    return {
      ...
      requireSessionFingerprinting:
        map.REQUIRE_SESSION_FINGERPRINTING === 'true',
  ...
  async updateSettings(
    ...
    const settingConfigs: {
      code: string;
      key: keyof UpdateSecuritySettingsDto;
    }[] = [
      ...
      {
        code: 'REQUIRE_SESSION_FINGERPRINTING',
        key: 'requireSessionFingerprinting',
      },
      ...
      if (data[key] !== undefined) {
        ...
        if (newValStr !== oldValStr) {
          ...
          await this.securityEventsService.log(
            SECURITY_EVENTS.SECURITY_SETTING_CHANGED,
            {
              userId: updatedBy,
              ipAddress,
              userAgent,
