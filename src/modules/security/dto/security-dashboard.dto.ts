...
export class SecuritySummaryDto {
    @ApiProperty({ description: 'Number of currently active, non-revoked sessions' })
    ...
    @ApiPropertyOptional({ description: 'Timestamp of the last successful login' })
    ...
    @ApiPropertyOptional({ description: 'Timestamp until which the account remains locked' })
