...
describe('SecurityModule (Step 1)', () => {
    ...
    beforeEach(async () => {
        mockSecurityRepository = {
            ...
            loginTrendChartData: jest.fn().mockResolvedValue([
                { date: '2026-08-20', success: 15, failure: 3 },
            ]),
            replayEventsChartData: jest.fn().mockResolvedValue([]),
            lockedAccountsChartData: jest.fn().mockResolvedValue([
                { username: 'locked.user', lockouts: 5 },
            ]),
            sessionsCreatedPerDayChartData: jest.fn().mockResolvedValue([
        ...
        dashboardService = module.get<SecurityDashboardService>(SecurityDashboardService);
    ...
    describe('SecurityDashboardService', () => {
        ...
        it('should get paginated security events', async () => {
            const result = await dashboardService.getSecurityEvents(new BaseQueryDto());
