...
export class SecuritySettingsController {
  ...
  async updateSettings(
    ...
    return this.securitySettingsService.updateSettings(
      dto,
      userId,
      ipAddress,
      userAgent,
  ...
  async revokeUserSession(
    ...
    return this.securitySettingsService.revokeSession(
      sessionId,
      adminUserId,
      ipAddress,
      userAgent,
  ...
  @RateLimit(RateLimitTier.TIER_2_SESSION)
  @ApiOperation({
    summary: 'Admin force-logout all active sessions for a target user',
  })
  async forceLogoutUser(
    ...
    return this.securitySettingsService.revokeAllSessionsForUser(
      userId,
      adminUserId,
      ipAddress,
      userAgent,
  ...
  @RateLimit(RateLimitTier.TIER_2_SESSION)
  @ApiOperation({
    summary: 'Emergency system-wide revocation of all active sessions',
  })
  async revokeAllSessionsSystemWide(): Promise<RevokeSessionsResponseDto> {
    ...
    return this.securitySettingsService.revokeAllSessionsSystemWide(
      adminUserId,
      ipAddress,
      userAgent,
    );
