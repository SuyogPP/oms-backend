...
export class UserActiveSessionDto {
    ...
    @ApiPropertyOptional({ description: 'Browser name extracted from user agent' })
    browserName?: string | null;

    @ApiPropertyOptional({ description: 'Device type (e.g. Desktop, Mobile, Tablet)' })
    ...
    @ApiProperty({ description: 'Whether this session matches the current caller session' })
