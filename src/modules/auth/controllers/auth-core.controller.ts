...
export class AuthCoreController {
    ...
    @ApiOperation({ summary: 'Rotate refresh token and issue new access token with replay detection' })
    ...
    async logout(): Promise<LogoutResponseDto> {
        ...
        return this.authCoreService.logout(loginSessionId, userId, ipAddress, userAgent);
    }
}
